...
public class EditLaptop extends AppCompatActivity {
    ...
    String id, spinner_merk, serilaptop, proc, spinner_ram, gpu, spinner_hdd, spinner_layar, gambar;
    ...
    private static final String TAG = EditLaptop.class.getSimpleName();
    private static final String TAG_SUCCESS = "success";
    private static final String TAG_MESSAGE = "message";
    private String url_edit = "http://universedeveloper.com/gudangandroid/ferdirockers/admin/update_laptop.php";  //directory php ning server
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinner_merk = getIntent().getStringExtra("merk_laptop");
        serilaptop = getIntent().getStringExtra("seri_laptop");
        proc = getIntent().getStringExtra("prosessor");
        spinner_ram = getIntent().getStringExtra("ram");
        gpu = getIntent().getStringExtra("gpu");
        spinner_hdd = getIntent().getStringExtra("hdd");
        spinner_layar = getIntent().getStringExtra("layar");
        ...
        String[] hdd = new String[] {
                "Pilih Hard Disk","40GB", "80GB", "128GB", "320GB", "500GB", "750GB", "1TB", "2TB", "4TB", "8TB", "16TB"
        };
        ...
        spinner_merk1.setAdapter(adapter_laptop);
        txt_serilaptop.setText(serilaptop);
        txt_prosessor.setText(proc);
        spinner_ram1.setAdapter(adapter_ram);
        txt_gpu.setText(gpu);
        spinner_hdd1.setAdapter(adapter_hdd);
        spinner_layar1.setAdapter(adapter_layar);
        Glide.with(EditLaptop.this)
                .load(gambar)
        ...
        btn_simpan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (spinner_merk == "Pilih Merk"){
                    Toast.makeText(EditLaptop.this, "Anda harus memilih Merk Laptop", Toast.LENGTH_SHORT).show();
                }

                else if (spinner_ram == "Pilih RAM"){
                    Toast.makeText(EditLaptop.this, "Anda harus memilih RAM", Toast.LENGTH_SHORT).show();
                }

                else if (spinner_hdd == "Pilih Hard Disk"){
                    Toast.makeText(EditLaptop.this, "Anda harus memilih Hard Disk", Toast.LENGTH_SHORT).show();
                }

                else if (spinner_layar == "Pilih Ukuran Layar"){
                    Toast.makeText(EditLaptop.this, "Anda harus memilih Ukuran Layar", Toast.LENGTH_SHORT).show();
                }
                else {
                    UpdateLaptop();
                }
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (success == 1) {  //jika berhasil maka :
                        ...
                        Toast.makeText(EditLaptop.this, jObj.getString(TAG_MESSAGE), Toast.LENGTH_LONG).show();
